"""
Django settings for sigefe_back project.
...
SECRET_KEY = 'django-insecure-_-5zdpot)g^r+5+lyps&x97c-4k49ol+ob*hsh5m1qb7%2ol1d'
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=15),  # Tiempo de expiración del token de acceso
    ...
    'USER_ID_FIELD': 'email',  # Usamos 'email' en lugar de 'username'
...
WSGI_APPLICATION = 'sigefe_back.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': config('MYSQL_NAME_DATABASE'),
